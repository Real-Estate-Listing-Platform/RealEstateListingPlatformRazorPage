...
namespace RealEstateListingPlatform.Pages.Listings
{
    public class AllListingsModel : PageModel
    {
        ...
        public AllListingsModel(IListingService listingService)
        {
        ...
        public string Title { get; set; } = "All Listings";
        ...
        public async Task OnGetAsync()
        {
            ...
            Title = titleParts.Count > 0 ? $"All Listings – {string.Join(", ", titleParts)}" : "All Listings";
