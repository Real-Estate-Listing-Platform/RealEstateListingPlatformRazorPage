...
namespace RealEstateListingPlatform.Pages.Admin
{
    ...
    public class DashboardModel : PageModel
    {
        ...
        public DashboardModel(IListingService listingService, IAdminDashboardService adminDashboardService, IAuditLogService auditLogService)
        {
        ...
        public BLL.DTOs.AdminDashboardStatsDto? DashboardStats { get; set; }
        public string Section { get; set; } = "dashboard";
        public int PendingCount { get; set; }

        public async Task<IActionResult> OnGetAsync()
        {
            ViewModel = await BuildAdminPortalViewModelAsync(1, 20);
            Section = "dashboard";
            PendingCount = ViewModel.PendingListings.Count;

            // Load real dashboard statistics
            DashboardStats = await _adminDashboardService.GetDashboardStatsAsync();
        ...
        private async Task<List<ListingApprovalViewModel>> GetPendingListingApprovalsAsync()
        {
            ...
            return listings.Select(l =>
            {
                ...
                return new ListingApprovalViewModel
                {
                    ...
                    IsUpdate = l.PendingSnapshotId.HasValue // Check if this is an edit
                };
            }).ToList();
        }
