...
namespace RealEstateListingPlatform.Pages.Admin
{
    ...
    public class ListingsModel : PageModel
    {
        ...
        public ListingsModel(IListingService listingService, IAdminDashboardService adminDashboardService, IAuditLogService auditLogService)
        {
        ...
        public string Section { get; set; } = "listings";
